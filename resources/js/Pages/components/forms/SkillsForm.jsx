...
const initialState = { name: "", rating: 0, thumbnail: "" };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            skillList.forEach((item) => {
                const existingItem = document.skills?.find(
                    (edu) => edu.id === item.id
                );
                if (existingItem) {
                    if (
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                        ...
                        <div key={index}>
                            <div className="relative flex items-center justify-between mb-5 pt-4 gap-3">
                                ...
                                <div className="flex-1">
                                    <Label className="text-sm">Name ( <Cpu  size="20px" className="inline-flex"/> ) :</Label>
                                    <Input
                                        name="name"
                                        required
                                        className="mt-2"
                ...
                <Button className="w-full" type="submit" disabled={!isFormValid || processing}>
                    {processing && (
